return { -- Fuzzy Finder (files, lsp, etc)
  ...
  config = function()
    ...
    end, { desc = '[S]earch [C]ode actions' })

    vim.keymap.set('n', '<leader>sR', function()
      require('telescope.builtin').lsp_references()
    end, { desc = '[S]earch [R]eferences' })

    vim.keymap.set('n', '<leader>slh', function()
      require('llm').search_llm_history_fuzzy()
    end, { desc = '[S]earch [L]LM history' })
    vim.keymap.set('n', '<leader>slf', function()
      require('llm').search_llm_history_files()
    end, { desc = '[S]earch [L]LM history' })
  end,
}
